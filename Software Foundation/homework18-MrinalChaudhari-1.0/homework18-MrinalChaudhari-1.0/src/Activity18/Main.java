...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Breadth first search A-C: " +graph.depthFirstSearch("A", "C"));
        System.out.println("Breadth first search A-G: " +graph.depthFirstPath("A", "G"));

        System.out.println("Breadth first path A-C: " +graph.depthFirstSearch("A", "C"));
        System.out.println("Breadth first path A-G: " +graph.depthFirstPath("A", "G"));
